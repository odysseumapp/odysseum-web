export default defineNuxtConfig({
  ...
  icon: { clientBundle: { scan: true, icons: ['lucide:book-open', 'lucide:book-text', 'lucide:users', 'lucide:user-round', 'lucide:map', 'lucide:map-pin', 'lucide:git-branch', 'lucide:route', 'lucide:notebook-pen', 'lucide:sticky-note', 'lucide:folder', 'lucide:circle', 'lucide:circle-check', 'lucide:arrow-left-right', 'lucide:x'] } },
